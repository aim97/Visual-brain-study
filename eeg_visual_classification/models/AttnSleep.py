...
class MRCNN(nn.Module):
    def __init__(self, afr_reduced_cnn_size):
        ...
        self.features1 = nn.Sequential(
            nn.Conv1d(128, 64, kernel_size=50, stride=6, bias=False, padding=24),
            nn.BatchNorm1d(64),
            self.GELU,
        ...
        self.features2 = nn.Sequential(
            nn.Conv1d(128, 64, kernel_size=400, stride=50, bias=False, padding=200),
            nn.BatchNorm1d(64),
            self.GELU,
...
class Model(nn.Module):
    def __init__(self, output_features=False):
        super(Model, self).__init__()
        self.output_features = output_features
        N = 2  # number of TCE clones
        d_model = 14  # set to be 100 for SHHS dataset
