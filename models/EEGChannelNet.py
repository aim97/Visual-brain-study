...
# 2020, doi: 10.1109/TPAMI.2020.2995909
import torch
...
class Model(nn.Module):
    ...
    The input is a tensor where each row is a channel the recorded signal and
    ...
    def __init__(
        ...
        encoding_size = (
            self.encoder(torch.zeros(1, in_channels, input_height, input_width))
            .contiguous()
            .view(-1)
            .size()[0]
        )
