...
class FrameCNN(nn.Module):
    def __init__(self, feat_dim=128):
        ...
        self.net = nn.Sequential(
            nn.Conv2d(1,32,3,1,1), nn.BatchNorm2d(32), nn.SiLU(),
            nn.Conv2d(32,64,3,2,1), nn.BatchNorm2d(64), nn.SiLU(),   # 32->16
            nn.Conv2d(64,128,3,2,1), nn.BatchNorm2d(128), nn.SiLU(), # 16->8
...
class TemporalBlock(nn.Module):
    def __init__(self, c_in, c_out, k=3, d=1, p_drop=0.1):
        ...
        self.net = nn.Sequential(
            ...
            nn.BatchNorm1d(c_out), nn.SiLU(), nn.Dropout(p_drop),
...
class CNN_TCN_Classifier(nn.Module):
    def __init__(self, n_classes=40, feat_dim=128, tcn_channels=(256,)*4):
        ...
        self.cls   = nn.Sequential(nn.AdaptiveAvgPool1d(1), nn.Flatten(),
                                   nn.Linear(self.tcn.out_ch, n_classes))
